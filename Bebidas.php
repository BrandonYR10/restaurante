...
<main>
    <div class="container" id="lista-productos"> 
        <div class="card-deck mb-3 text-center">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header">
                    <h4 class="my-0 font-weight-bold">Coca Cola 1.5 LT</h4>
                </div>
                <div class="card-body">
                    <img src="img/coca-1-5.jpg" class="card-img-top" >
                    <h1 class="card-title pricing-card-title precio">S/. <span class="">5.00</span></h1>
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header">
                    <h4 class="my-0 font-weight-bold">Inka Cola 1.5 LT</h4>
                </div>
                <div class="card-body">
                    <img src="img/inca-kola-1-5.jpg" class="card-img-top">
                    <h1 class="card-title pricing-card-title precio">S/. <span class="">5.00</span></h1>
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header">
                    <h4 class="my-0 font-weight-bold">Jarra Chicha Morada</h4>
                </div>
                <div class="card-body">
                    <img src="img/chicha.jpg" class="card-img-top">
                    <h1 class="card-title pricing-card-title precio">S/. <span class="">6.00</span></h1>
        ...
        <div class="card-deck mb-3 text-center">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header">
                    <h4 class="my-0 font-weight-bold">Jarra Maracuya</h4>
                </div>
                <div class="card-body">
                    <img src="img/Maracuya.jpg" class="card-img-top">
                    <h1 class="card-title pricing-card-title precio">S/. <span class="">6.00</span></h1>
